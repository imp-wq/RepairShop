    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://henry-wp.sentry.io/issues/?project=4509888648839168">Issues Page</a>.
